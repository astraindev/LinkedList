 ...
 */
public class OldSchoolLinkedList<E> implements Iterator<E>, Iterable<E> {
    private OldSchoolNode<E> head;
    private OldSchoolNode<E> current;
    private int size;
     ...
     */
    public OldSchoolLinkedList<E> nextElement() {
        if (current != null) {
     ...
     * @return a pointer back to this linked list
     */
    public OldSchoolLinkedList<E> gotoIndex(int index) {
        checkIndex(index);
        begin();
     ...
     */
    public OldSchoolLinkedList<E> insert(E element) {
        OldSchoolNode<E> newNode = new OldSchoolNode<>(element);
     ...
     * @return a reference back to this linked list
     */
    public OldSchoolLinkedList<E> append(E element) {
    ...
    public E pop() {
        ...
        gotoIndex(size - 2);
        OldSchoolNode<E> previous = current;
        gotoIndex(size - 1);
